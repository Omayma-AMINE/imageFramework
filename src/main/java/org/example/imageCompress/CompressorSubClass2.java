...
public class CompressorSubClass2 extends CompressorTemplate{
    @Override
    public void preCompress(int[] data) {
        System.out.println("La compresseur 2 est lancé");
        int s =0;
        for (int d : data) {
            s = s+d;
        }
    ...
    public void postCompress(int [] data) {
        ...
        System.out.println("Compression effectué avec le compresseur 2 ");
    }
}
